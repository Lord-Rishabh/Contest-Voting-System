  ...
  const handleContestSumbit = async (e) => {
    ...
    try {
      await handleCreateContest(
        ...
        contestDetails.endTimeInSeconds
      );
      ...
      <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
        <div className="mr-6">
          ...
          <h2 className="text-md md:text-lg text-gray-500 ">
            Transparent, fair, decentralized contest voting platform.
          </h2>
        </div>
        <div className="flex flex-wrap items-start justify-end relative">
          <button
            onClick={toggleCreateContestForm}
            className="inline-flex px-4 md:px-5 py-3 text-sm md:text-base text-purple-600 hover:text-purple-700 focus:text-purple-700 hover:bg-purple-100 focus:bg-purple-100 border border-purple-600 rounded-md mb-3"
          >
            <svg
              aria-hidden="true"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              className="flex-shrink-0 h-4 md:h-5 w-4 md:w-5 -ml-1 mt-0.5 md:mt-1 mr-2"
            >
              <path
                strokeLinecap="round"
              ...
              <form onSubmit={handleContestSumbit} className="space-y-4">
                ...
                <div className="py-1">
                  ...
                  <input
                    ...
                    id="endTime"
                    name="endTime"
                    value={contestDetails.endTimeInSeconds}
